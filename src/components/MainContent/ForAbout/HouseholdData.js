    ...
    <div className='user-info-body'>
      <ul>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.household_number === '' ? value.household_number : '-'}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.owner_sex === 'Male' ? 'पुरुष (Male)' : 'महिला (Female)'}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.owner_caste_other === 'nan' ? '-' : value.owner_caste_other}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.religion_other === 'nan' ? '-' : value.religion_other}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.other_occupation === 'nan' ? '-' : value.other_occupation}
          </span>
        </li>

        <li className='user-span14'>
          <span>Business</span>
          <span>{value.business === 'nan' ? '-' : value.business}</span>
        </li>

        <li className='user-span14'>
          <span>Other Business</span>
          <span>
            {value.other_business === 'nan' ? '-' : value.other_business}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.other_small_business === 'nan'
              ? '-'
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.crop_sufficiency === 'nan' ? '-' : value.crop_sufficiency}
          </span>
        </li>

        <li className='user-span14'>
          <span>Food Type</span>
          <span>{value.food_type === 'nan' ? '-' : value.food_type}</span>
        </li>

        <li className='user-span14'>
          <span>Monthly Expenses</span>
          <span>
            {value.monthly_expenses === 'nan'
              ? '-'
        ...
        <li className='user-span14'>
          <span>Loan</span>
          <span>{value.loan === 'nan' ? '-' : value.loan}</span>
        </li>

        <li className='user-span14'>
          <span>Loan Amount</span>
          <span>{value.loan_amount === 'nan' ? '-' : value.loan_amount}</span>
        </li>

        <li className='user-span14'>
          <span>Loan Duration</span>
          <span>
            {value.loan_duration === 'nan' ? '-' : value.loan_duration}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.animal_presence === 'nan' ? '-' : value.animal_presence}
          </span>
        </li>

        <li className='user-span14'>
          <span>Insurance</span>
          <span>{value.insurance === 'nan' ? '-' : value.insurance}</span>
        </li>

        <li className='user-span14'>
          <span>Vehicle</span>
          <span>{value.vehicle === 'nan' ? '-' : value.vehicle}</span>
        </li>

        <li className='user-span14'>
          <span>Facilities Type</span>
          <span>
            {value.facilities_type === 'nan' ? '-' : value.facilities_type}
          </span>
        </li>

        <li className='user-span14'>
          <span>Fuel Type</span>
          <span>{value.fuel_type === 'nan' ? '-' : value.fuel_type}</span>
        </li>

        <li className='user-span14'>
          <span>Land Ownership</span>
          <span>
            {value.land_ownership === 'nan' ? '-' : value.land_ownership}
          </span>
        </li>

        <li className='user-span14'>
          <span>House Type</span>
          <span>{value.house_type === 'nan' ? '-' : value.house_type}</span>
        </li>

        <li className='user-span14'>
          <span>House Storey</span>
          <span>
            {value.house_stories === 'nan' ? '-' : value.house_stories}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.owned_land_area === 'nan' ? '-' : value.owned_land_area}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.distance_from_main_road === 'nan'
              ? '-'
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.distance_from_nearest_school === 'nan'
              ? '-'
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.distance_from_nearest_health_institution === 'nan'
              ? '-'
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.distance_from_nearest_security_forces === 'nan'
              ? '-'
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.distance_to_nearest_open_space === 'nan'
              ? '-'
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.distance_to_nearest_market === 'nan'
              ? '-'
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.distance_to_alternative_market === 'nan'
              ? '-'
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.water_sources === 'nan' ? '-' : value.water_sources}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.tubewell_type === 'nan' ? '-' : value.tubewell_type}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.tubewell_status === 'nan' ? '-' : value.tubewell_status}
          </span>
        </li>
        ...
        <li className='user-span14'>
          ...
          <span>
            {value.toilet_facility === 'nan' ? '-' : value.toilet_facility}
          </span>
        </li>

        <li className='user-span14'>
          <span>Toilet Type</span>
          <span>{value.toilet_type === 'nan' ? '-' : value.toilet_type}</span>
        </li>

        <li className='user-span14'>
          <span>Disaster Type</span>
          <span>
            {value.disaster_type === 'nan' ? '-' : value.disaster_type}
          </span>
        </li>
      </ul>
    </div>
