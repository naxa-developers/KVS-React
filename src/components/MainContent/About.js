...
console.log("indiv", response.data);
        ...
        var detailsArray = [owner_name, owner_age, owner_sex, owner_citizenship_no, contact_no, ward, social_security_received, family_size, place_name, date]
        this.setState({
  ...
  submitHandler = () => {
    ...
    Axios(
      `http://139.59.67.104:8019/api/v1/house_hold/${localStorage.getItem('indexValue')}/`,
      {
        method: 'PUT',
        data: data,
        headers: {
                ...
                >
                  ...
                  <main>
                    <div className="user-info">
                      ...
                      <div style={{ display: this.state.i === 1 ? 'block' : 'none' }}>
                        <IndividualData value={value} personalData={this.state.personalData} />
                      </div>
                      <div style={{ display: this.state.i === 2 ? 'block' : 'none' }}>
